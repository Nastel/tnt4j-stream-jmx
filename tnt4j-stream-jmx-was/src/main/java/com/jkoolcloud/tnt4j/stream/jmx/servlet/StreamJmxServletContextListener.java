...
/**
 * JMX stream {@link SamplingAgent} integration into J2EE compliant webApp starting JMX sampling on servlet context
 ...
 */
public class StreamJmxServletContextListener implements ServletContextListener {
	@Override
	public void contextInitialized(ServletContextEvent event) {
		...
		try {
			...
			StreamJMXManager.getInstance().samplerStart();
		} catch (Exception e) {
	...
	public void contextDestroyed(ServletContextEvent event) {
		...
		StreamJMXManager.getInstance().samplerDestroy();
		console.stop();
	}
}
