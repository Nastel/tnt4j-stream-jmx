...
$JAVA_EXEC $TNT4JOPTS -classpath "$LIBPATH" com.jkoolcloud.tnt4j.stream.jmx.SamplingAgent -attach -vm:$1 -ap:"$SCRIPTPATH/../tnt4j-stream-jmx-core-1.16.1-all.jar" -ao:$TNT4J_AGENT_OPTIONS $TNT4J_AGENT_ARGS