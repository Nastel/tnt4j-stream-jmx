...
"$JAVA_HOME/bin/java" $TNT4JOPTS -classpath "$LIBPATH" com.jkoolcloud.tnt4j.stream.jmx.SamplingAgent -attach -vm:$1 -ap:"$SCRIPTPATH/../lib/tnt4j-stream-jmx-core-0.8.6-all.jar" -ao:$TNT4J_AGENT_OPTIONS $TNT4J_AGENT_ARGS