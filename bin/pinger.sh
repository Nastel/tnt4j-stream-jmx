...
TNT4JOPTS=$TNT4JOPTS -Dlog4j.configuration=file:"$RUNDIR../config/log4j.properties" -Dtnt4j.config="$RUNDIR..config/tnt4j.properties" -Dtnt4j.token.repository="$RUNDIR../config/tnt4j-tokens.properties"
