...
define full or relative path, e.g., `..\build\tnt4j-stream-jmx\tnt4j-stream-jmx-0.13.1\tnt4j-stream-jmx-core-all.jar`. Mandatory 
argument.
...
<server description="new server">
    ...
    <application contextRoot="tnt-jmx" location="tnt4j-stream-jmx-liberty-war-0.13.1.war" type="war" id="tnt-jmx" name="tnt-jmx">
        <application-bnd>
