...
Use PingJMX to embed a monitoring agent within your application and monitor memory, GC activity, CPU as
...
<b>NOTE:</b> JESL provides a way to stream events generated by PingJMX  to jKool Cloud. 
...
PingJMX allows you to associate conditions with user defined actions based on values of MBean attributes on each sampling
